...
describe "Authentication" do
  ...
  describe "signin" do
    ...
    describe "with invalid information" do
      ...
      #avove line replaces, and is matched with,
      #the following line, which is now found in the
      #spec/support/utilities.rb file:
    ...
    describe "with valid information" do
      ...
      before { sign_in user }
=begin
      See spec/support/utilities.rb field for "sign_in user" function above

      /THE above line replaced lines below, which also comprise
      the "valid_signin"  function above.
    ...
    describe "for non-signed-in users" do
      ...
      describe "in the Users controller" do
        ...
        describe "submitting to the update action" do
          ...
          #"put" is only way to get to update action in user controller
          #application would do it by submitting the edit form
